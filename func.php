    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
          <a href="petition.php" class="nav-link activeM2">
          <i class="nav-icon fas fa-bell"></i>
            <p>คำร้องการเข้าใช้ตึก</p>
          </a>
        </li>
          ...
          <li class="nav-item openM5">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="today.php" class="nav-link activeM51">
                  <i class="far fa-circle nav-icon"></i>
                  <p>รายวัน</p>
                </a>
              </li>
              <li class="nav-item">
              <a href="week.php" class="nav-link activeM52">
                <i class="far fa-circle nav-icon"></i>
                <p>รายสัปดาห์</p>
              </a>
            </li>
            <li class="nav-item">
              <a href="month.php" class="nav-link activeM53">
                <i class="far fa-circle nav-icon"></i>
                <p>รายเดือน</p>
              </a>
            </li>
          ...
          <li class="nav-item">
            <a href="logout_Process.php" class="nav-link activeM7">
