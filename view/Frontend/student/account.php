...
if ($_SESSION['status'] != 'student') { //check session
  ...
  $dbname = "sqlfacedata";
  $conn = mysqli_connect($servername, $username, $password, $dbname);
  $sql = "SELECT DISTINCT a.student_id, a.name, a.Lname, a.branch, a.Phone, a.Student_card, b.img_face, b.certificate, b.atk
            FROM students a, register_in b
            WHERE b.student_id = a.student_id AND b.student_id = $student_id";
        ...
        <section class="content">
          <div class="container-fluid">
            <div class="row">
              <div class="col-6">
                <div class="card">
                  <div class="card-header"> <?php while ($row = mysqli_fetch_assoc($student)) { ?>
                      <H2>Account <a href="account_edit.php?student_id=<?php echo $row['student_id']; ?>" class="btn btn-success float-right" value="Edit"><i class="fas fa-edit"></i>&nbsp;แก้ไขข้อมูล</button></a></H2>
                      ...
                      <div class="row row-space">
                        ...
                        <div class="col-4">
                          ...
                          <div class="input-group">
                            <a href="../<?php echo $row['Student_card']; ?>"><img src="../<?php echo $row['Student_card']; ?>" width="50%" height="100%"></a>
                          </div>
                        </div>
                        <div class="col-3">
                          <div class="input-group">
                            ...
                            <?php
                                              ...
                                              if (!empty($imageData)) {
                                                ...
                                                foreach ($imageList as $image) {
                                                  ...
                                                  echo '<img src="' . $imageSrc . '" alt="รูปภาพนักศึกษา" width="50%" height="100%"></a>';
                                                }
                                              } else {
                                                echo 'ไม่มีรูปภาพ';
                                              }
                      ...
                      <div class="row row-space">
                        ...
                        <div class="col-4">
                          ...
                          <div class="input-group">
                            <a href="../<?php echo $row['certificate']; ?>"><img src="../<?php echo $row['certificate']; ?>" width="80%" height="100%"></a>
                          </div>
                        </div>
                        <div class="col-3">
                          <div class="input-group">
                          ...
                          <div class="input-group">
                            <a href="../<?php echo $row['atk']; ?>"><img src="../<?php echo $row['atk']; ?>" width="80%" height="100%"></a>
                          </div>
                        </div>
                      </div>
