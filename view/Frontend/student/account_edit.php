              ...
              <div class="col-6">
                <div class="card">
                  <div class="card-header">
                    <H2>Edit Account </H2>
                    <form name="regis" action="../../Backend/Process_updateac.php" method="post" enctype="multipart/form-data" name="upfile" id="upfile">
                      <div class="row row-space">
                        ...
                        <div class="row row-space">
                          ...
                          <div class="col-sm-6">
                            <div class="form-group">
                              <label>นามสกุล</label>
                              <input type="text" class="form-control" name="Lname" required value="<?php echo $result['Lname']; ?>">
                            </div>
                          </div>
                        </div>
                      </div>
                      <div class="row row-space">
                        ...
                        <div class="row row-space">
                          ...
                          <div class="col-sm-6">
                            <div class="form-group">
                              <label>สาขา</label>
                              <select name="branch" class="form-control custom-select" name="branch" style="width: 100%;" value="<?php echo $result["branch"]; ?>">
                      ...
                      <div class="row row-space">
                          ...
                          <div class="col-12">
                            ...
                            <div class="form-group">
                              ...
                              <div class="custom-file">
                                <input type="file" class="custom-file-input" id="customFile" name="Student_card" required accept="image/*" value="<?php echo $result["Student_card"]; ?>">
                                <label class="custom-file-label" for="customFile"><?php echo $result["Student_card"]; ?></label>
                              </div>
                            </div>
                          </div>
                        </div>
                        ...
                        <div class="row row-space">
                          <div class="col-4">
                            <button type="submit" name="submit" class="btn btn-success float-right">อัปเดตข้อมูล</button>
                          </div>
                          <div class="col-2">
