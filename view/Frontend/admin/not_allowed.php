  ...
  <body class="hold-transition sidebar-mini">
    <div class="wrapper">
      ...
      <div class="content-wrapper"><br>
        ...
        <form name="regis_in" action="../../Backend/Process_notallow.php" method="post" enctype="multipart/form-data" name="upfile" id="upfile">
              ...
              <div class="col-6">
                <div class="card">
                  <div class="card-header">
                    <H2><i class="fas fa-user"></i>&nbsp;ไม่อนุมัติ</H2>
                    ...
                    <div class="row row-space">
                      ...
                      <div class="col-4">
                        <div class="form-group">
                          ...
                          <textarea  rows="3" class="form-control float-right" name="comment"> </textarea>
                          </div>
                          <!-- /.input group -->
                        </div>
