...
$sql= "SELECT DISTINCT a.student_id,a.name ,a.Lname ,a.branch,b.date ,b.time from students a, tb_camera b WHERE b.student_id =a.student_id AND DATE(date)=CURRENT_DATE()" or die("ERROR : ".$mysqli->error);
...
<head>
  ...
  <title>ประวัติการเข้าคณะ-รายวัน</title>
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">รายวัน</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
