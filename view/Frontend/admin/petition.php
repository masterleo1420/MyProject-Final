...
$sql = "SELECT a.student_id, b.name ,b.Lname ,b.branch, a.date_in FROM register_in a ,students b  WHERE  a.student_id = b.student_id AND a.status_regis = 2";
              ...
              <table id="product" class="table table-hover" data-live-search="true">
                  ...
                  <?php $i = 1; while($row = mysqli_fetch_array($rsprd)) { ?> 
                    ...
                    <tr>
                          ...
                          <td><p><?php echo $row ['date_in']?></p></td>
                          <td><a href="checkstudent.php?student_id=<?php echo $row['student_id']; ?>"  type="submit"  class="btn btn-success float-left">ตรวจสอบ</a></td>
